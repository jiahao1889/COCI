...
<li><a href="news.jsp">最新消息</a></li>
  ...
  <div class="content">
    <h1><!-- InstanceBeginEditable name="TitleEditRegion" -->首页<!-- InstanceEndEditable --></h1>
    <div id="images"><img src="indexImage.jpg" alt="newsImage" /></div>
    <div id = "news">
        ...
        for(int i=0; i < a.size(); i++)
        {
         int itd=(a.get(i).getID());
            ...
            <%=a.get(i).getTitle()%> <%=a.get(i).getDate().toString()%></a>
        	<br></br>
        	<%
        }%>
    </div>
