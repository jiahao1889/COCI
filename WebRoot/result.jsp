<%@ page contentType="text/html; charset=utf-8" language="java"
	import="java.sql.*,java.util.Date" import="java.text.SimpleDateFormat"
	errorPage=""%>
		...
		<div class="container">
			...
			<div class="content">
				...
				<%
					...
					if (request.getParameter("mon1") != null
							&& request.getParameter("mon1") != "") {
					...
					if (request.getParameter("mi1") != null
							&& request.getParameter("mi1") != "") {
					...
					if (request.getParameter("mon2") != null
							&& request.getParameter("mon2") != "") {
					...
					if (request.getParameter("mi2") != null
							&& request.getParameter("mi2") != "") {
					...
					alist.AddAct(title, content, place, acturl, actDate, deadline,
							classify, maxnum, uid);
				%>
				<p>
					发布成功！
