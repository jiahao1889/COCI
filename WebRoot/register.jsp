...
<li><a href="news.jsp">最新消息</a></li>
  ...
  <div class="content">
    <h1><!-- InstanceBeginEditable name="TitleEditRegion" -->注册<!-- InstanceEndEditable --></h1>
    <!-- InstanceBeginEditable name="TextEditRegion" -->    <form id="form1" name="form1" method="post" action="register2.jsp"  onsubmit="return check()" >
      <p>
