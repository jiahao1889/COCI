...
<li><a href="news.jsp">最新消息</a></li>
  ...
  <div class="content">
	...
	<form action="result.jsp" method="post" onsubmit="return check()">
	  <div>
	  ...
	  <div>
		<label >活动日期：</label>
		<label >年:</label>
		<input type="text" maxlength="4" name="y1" />
		<label >月:</label>
		<input type="text" maxlength="2" name="mon1"/>
		<label >日:</label>
		<input type="text" maxlength="2" name="d1" />
		<label >时:</label>
		<input type="text" maxlength="2" name="h1" />
		<label >分:</label>
		<input type="text" maxlength="2" name="mi1" /> 
	  </div>
	  <div>
		<label >截止日期：</label>
		<label >年:</label>
		<input type="text" maxlength="4" name="y2" />
		<label >月:</label>
		<input type="text" maxlength="2" name="mon2"/>
		<label >日:</label>
		<input type="text" maxlength="2" name="d2" />
		<label >时:</label>
		<input type="text" maxlength="2" name="h2" />
		<label >分:</label>
		<input type="text" maxlength="2" name="mi2" /> 
	  </div>
	  <div>
	   
		<label >活动地点:</label>
		<input type="text" maxlength="50" name="place"/>
	  </div>
	  	  <div>
	   
		<label >活动分类:</label>
		<input type="text" maxlength="50" name="classify"/>
	  </div>
	  	  <div>
	   
		<label >人数限制:</label>
		<input type="text" maxlength="50" name="maxnum"/>
	  </div>
	  	  <div>
	   
		<label >活动连接:</label>
		<input type="text" maxlength="100" name="acturl"/>
	  </div>
	  <div>
	       <label >活动内容:</label>
