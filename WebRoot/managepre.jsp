...
<li><a href="news.jsp">最新消息</a></li>
 ...
 <%
    if(request.getParameter("userName")==null&&request.getParameter("auxy")==null){%>   
<form id="form1" name="form1" method="post" action="managepre.jsp">
  <p>
    <label for="userName">用户名</label>
    <input type="text" name="userName" id="userName" />
  </p>
  <p>
    <label for="passwordl">权限</label>
    <label><input type="radio" name="auxy" value="1"/>学生</label>
     <label><input type="radio" name="auxy" value="2"/>社团</label>
      <label><input type="radio" name="auxy" value="3"/>管理员</label>
  </p>
  <p>
    <input type="submit" name="apply" id="apply" value="确认" />
...
<%
      ...
      int auxy = Integer.parseInt(request.getParameter("auxy"));
      	Admin admin=(Admin)session.getAttribute("muser");
      	admin.privilege(userName,auxy);
      	 %><p>修改成功！</p><%
      }
